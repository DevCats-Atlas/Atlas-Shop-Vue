...
export class DynamicFieldLoader {
     ...
     */
    async loadOptions(fieldName, dependencyResolver) {
     ...
     */
    async loadOptionsWithDependencies(fieldName, dependencies) {
     ...
     */
    resolveDependencies(fieldName, dependencyResolver) {
     ...
     */
    hasAllDependencies(fieldName, dependencyResolver) {
        const field = this.fields[fieldName];
        if (!field || !field.depends_on) {
            return true;
        }
     ...
     */
    getMissingDependencies(fieldName, dependencyResolver) {
        const field = this.fields[fieldName];
        if (!field || !field.depends_on) {
            return [];
        }
...
//# sourceMappingURL=DynamicFieldLoader.js.map